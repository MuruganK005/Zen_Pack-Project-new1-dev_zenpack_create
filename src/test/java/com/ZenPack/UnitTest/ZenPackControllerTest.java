...
public class ZenPackControllerTest {
    ...
    public void testZenPackController() throws Exception {
        ...
        zenPackDto.setMenus(List.of(menuDto));
        zenPackDto.setFeatures(List.of(featureDto1));
        ...
        String URI="/api/v1";
        when(service.createZenPack(any(ZenPackDto.class))).thenReturn(zenPackDto);
